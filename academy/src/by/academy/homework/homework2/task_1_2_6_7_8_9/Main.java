	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < products.length; i++) {
			...
			if (type.equals("продукт1")) {
				products[i] = new Product1(productName, price, quantity, type);
			}else if (type.equals("продукт2")) {
				products[i] = new Product2(productName, price, quantity, type);
			}else if (type.equals("продукт3")) {
				products[i] = new Product3(productName, price, quantity, type);
			}
		}
